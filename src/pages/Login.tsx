// ============================================
// MY HEALTH BUDDY - Login Page
// Mobile-first sign in with Supabase auth
// ============================================
...
export default function Login() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      // OAuth redirects away; if we come back, session will be set
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col">
      ...
      <div className="flex-1 px-5 pt-4 pb-8 max-w-sm mx-auto w-full">
        ...
        <h1 className="text-xl font-bold text-neutral-800 text-center mb-1">
          Welcome Back
        </h1>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-neutral-200 bg-white font-semibold text-neutral-700 hover:bg-neutral-50 active:bg-neutral-100 disabled:opacity-70"
        >
